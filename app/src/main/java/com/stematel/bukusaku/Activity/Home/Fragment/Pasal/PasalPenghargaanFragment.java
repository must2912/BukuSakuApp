 ...
 */
public class PasalPenghargaanFragment extends Fragment implements PaginationAdapterCallback {
    ...
    public PasalPenghargaanFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_pasal_penghargaan, container, false);
    ...
    private void loadNextPage() {
        ...
        Call<ResponseService<PasalResponse>> produkCall = NetworkClient.getInstance().getApiService().getPenghargaan(pagePost);
