...
public class PeraturanAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public PeraturanAdapter(Context context) {
    ...
    public void onBindViewHolder (final RecyclerView.ViewHolder holder, final int position){
        ...
        switch (getItemViewType(position)) {
            ...
            case ITEM:
                final PeraturanHolder movieVH = (PeraturanHolder) holder;
